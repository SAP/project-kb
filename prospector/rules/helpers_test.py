...
#         assert (
#             extract_changed_relevant_paths(commit, advisory_record)
#             == matched_paths
#         )
...
# def test_extract_extract_commit_mentioned_in_linked_pages(
#     repository, requests_mock
# ):
#     requests_mock.get(
...
#     )
#     assert (
#         extract_commit_mentioned_in_linked_pages(commit, advisory_record) == 1
#     )
...
#     )
#     assert (
#         extract_commit_mentioned_in_linked_pages(commit, advisory_record) == 0
#     )
...
#             random_list_of_cve(max_count=1, min_count=1).keys()
#         )[0],
#         keywords=keywords,
#     )
